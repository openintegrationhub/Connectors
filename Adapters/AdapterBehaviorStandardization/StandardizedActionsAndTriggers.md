...
**Version Publish Date: 05.12.2018**
...
- [Actions/Triggers Not Standardized](#actionstriggers-not-standardized)
...
# Actions/Triggers Not Standardized
- Execute Query or Statement in Query Language (e.g. SQL, Salesforce’s SOQL, etc)
- Perform Action/Evaluate Function (e.g. sendEmail, calculatePrice)
- Webhooks

...
3. For actual implementations of Adapters, please checkout our examples for [`SnazzyContacts`](https://github.com/openintegrationhub/snazzycontacts-adapter) and [`Wice`](https://github.com/openintegrationhub/wicecrm-adapter)!

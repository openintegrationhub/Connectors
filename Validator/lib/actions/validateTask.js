...
const task = require('../schemas/collaboration/task.json');
const subtask = require('../schemas/collaboration/subtask.json');
...
async function processAction(msg, cfg) {
  ...
  try{
  let ajv = new Ajv();
  let validate = ajv.addSchema(subtask).addSchema(collaborationelement).addSchema(record).compile(task);
